  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="p-6">
        ...
        {/* Search container with logout button on the left */}
        <div className="flex justify-center mb-6 relative">
          {/* Logout button positioned to the left of search */}
          <Button
            onClick={() => {
            ...
            variant="ghost"
            size="sm"
            className="text-gray-400 hover:text-white flex items-center gap-2 absolute left-0 top-1/2 transform -translate-y-1/2"
            title="Logout"
          >
            <svg
              width={18}
