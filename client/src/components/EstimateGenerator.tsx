...
<html lang="en">
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="wide-dialog max-h-[90vh] h-[90vh] overflow-y-auto bg-black text-white [&>button]:hidden" style={{ left: '1vw', transform: 'translateY(-50%)', width: '98vw', maxWidth: '90rem' }}>
