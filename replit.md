...
- June 27, 2025. Integrated custom A-Frame Painting logo: Replaced text-based "A-FRAME PAINTING" branding with user's professional logo featuring colorful stripes and clean typography. Logo now appears centered at top of homepage and in PDF invoice headers. Logo file saved as /public/aframe-logo.png and properly sized for both web display (h-16) and PDF generation (h-12). Maintains professional branding consistency across all user-facing interfaces.
